...
// NOTE:: NEEDS LETTERINVENTORY class provided elsewhere!!
// Also needs a txt file that with a list of words to act as a dictionary!!
...
public class AnagramMain {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (phrase.length() > 0) {
            ...
            // ex: 12247 ms elapsed, 2594392 unique LetterInventory object(s) created
            if (TIMING) {
